...
@section('content')
    <form method="GET" action="{{ route('send_sms') }}" class="form-signin">
        ...
        @csrf
        <input id="phone" type="tel" pattern="[789][0-9]{10}" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('name') }}" required autofocus placeholder="Phone">               
